...
class ArticleContentBaristaStoriesPage extends StatelessWidget {
  const ArticleContentBaristaStoriesPage({super.key});
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Barista Story: 6 Years and Decide to Leave',
