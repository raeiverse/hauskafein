...
import 'package:hauskafein/ui/widget/MagazineCard.dart';
import 'package:hauskafein/ui/widget/magazine/teamreview/teamreviewpage/HeaderTeamReviewPage.dart';

import '../../../../pages/BottomNavbarWidget.dart';

class TeamReviewPage extends StatelessWidget {
  const TeamReviewPage({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                MagazineCard(
                  ...
                  date: '17 Jan 2022',
                  nextPage: '/articleteamreviewpage',
                ),
              ],
            ),
          ),
