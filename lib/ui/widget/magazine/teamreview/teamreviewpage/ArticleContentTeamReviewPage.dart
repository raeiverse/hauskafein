...
class ArticleContentTeamReviewPage extends StatelessWidget {
  const ArticleContentTeamReviewPage({super.key});
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'A Review: Office Coffee Story and Development',
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage(
                        'assets/images/magazine/images_articleContent.png'),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Image.asset(
                        'assets/images/icon_tagCoffee.png',
                        width: 24,
                        height: 24,
                      ),
                      Padding(
